...
export async function participantsUpdate({ id, participants, action }) {
  ...
  this.sendHydrated2(id, text, wm + '\n\n' + botdate, action === 'add' ? pp : pp, sgc, (action == 'add' ? 'Group' : 'Nitip Gorengan'), null, null, [
      ['🎀 Menu', '/menu'],
      ['🪄 Test', '/ping'],
...
${htjava} Fitur ini di *disable* !`
    ...
    if (msg) return conn.sendHydrated(m.chat, msg, wm, hwaifu.getRandom(), null, null, nomorown, nameown, [
            ['🔖Ok', 'Huuu']
                ], m)
}

...
let name = await conn.getName(who)
	...
	if (!/text|json/.test(res.headers.get('content-type'))) return conn.sendFile(m.chat, url, 'file', text, m, null, { quoted: fkontak,  fileName: ucapan, pageCount: fpagedoc, fileLength: fsizedoc, seconds: fsizedoc, contextInfo: {
          externalAdReply :{
    mediaUrl: sig,
    mediaType: 2,
    description: wm, 

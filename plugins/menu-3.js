...
%readmore
*Support me:* _https://saweria.co/arifzyn_
*Note:*
...
let tek = `👋 Hallo @${who.split("@")[0]} ${ucapan()}
...
const listMessage = {
  ...
  if (teks == '404') {
    ...
    conn.sendHydrated(m.chat, text.trim(), wm + '\n\n' + botdate, hwaifu.getRandom(), gcwangsaf, 'SkyBotz Group', who.split`@`[0], em.getRandom() + ' Your Number', [
      ['🎀 Menu', '/menu'],
      ['🪄 Owner', '/owner'],
      ['🔖 Test', '/ping']
